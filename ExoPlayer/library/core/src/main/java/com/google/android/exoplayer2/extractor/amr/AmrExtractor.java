...
public final class AmrExtractor implements Extractor {
    ...
    private int readSample(ExtractorInput extractorInput) throws IOException, InterruptedException {
        ...
        Log.d("amrglee", currentSampleBytesRemaining + "");
        Log.d("amrglee", extractorInput.getLength() + "length");
        Log.d("amrglee", extractorInput.getPeekPosition() + "pp");
        Log.d("amrglee", extractorInput.getPosition() + "p");
        int bytesAppended =
