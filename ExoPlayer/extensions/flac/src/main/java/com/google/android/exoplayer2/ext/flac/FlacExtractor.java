...
public final class FlacExtractor implements Extractor {
    ...
    public FlacExtractor(int flags) {
        Log.d("glee" + getClass().getSimpleName(), "constructor\n" + flags + "");
    ...
    public void init(ExtractorOutput output) {
        Log.d("glee" + getClass().getSimpleName(), "init\n" + output.toString() + "");
    ...
    public boolean sniff(ExtractorInput input) throws IOException, InterruptedException {
        Log.d("glee" + getClass().getSimpleName(), "sniff\n" + input.getLength()+"\t"+input.getPeekPosition()+"\t"+input.getPosition());
    ...
    public int read(final ExtractorInput input, PositionHolder seekPosition)
        ...
        Log.d("glee" + getClass().getSimpleName(), "read\n" + input.getLength()+"\t"+input.getPeekPosition()+"\t"+input.getPosition()+"\t"+seekPosition.position);
    ...
    public void seek(long position, long timeUs) {
        Log.d("glee" + getClass().getSimpleName(), "seek\n" + position+"\t"+timeUs);
