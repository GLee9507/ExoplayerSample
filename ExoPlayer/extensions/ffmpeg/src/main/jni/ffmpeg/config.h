...
#define FFMPEG_CONFIGURATION "--libdir=android-libs/armeabi-v7a --arch=arm --cpu=armv7-a --incdir=/mnt/d/android-project/ExoplayerSample/ExoPlayer/extensions/ffmpeg/src/main/jni/includes --cross-prefix=/home/glee/Android/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi- --sysroot=/home/glee/Android/android-ndk-r15c/platforms/android-19/arch-arm/ --extra-cflags='-march=armv7-a -mfloat-abi=softfp' --extra-ldflags='-Wl,--fix-cortex-a8' --extra-ldexeflags=-pie --target-os=android --disable-static --enable-shared --disable-doc --disable-programs --disable-everything --disable-avdevice --enable-avformat --disable-swscale --disable-postproc --disable-avfilter --disable-symver --disable-swresample --enable-avresample --enable-decoder=vorbis --enable-demuxer=vorbis --enable-decoder=opus --enable-demuxer=opus --enable-decoder=ape --enable-demuxer=ape --enable-parser=ape --enable-muxer=ape"
