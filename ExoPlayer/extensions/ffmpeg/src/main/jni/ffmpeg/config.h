...
#define FFMPEG_CONFIGURATION "--libdir=android-libs/armeabi-v7a --arch=arm --cpu=armv7-a --cross-prefix=/home/glee/Android/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi- --sysroot=/home/glee/Android/android-ndk-r15c/platforms/android-14/arch-arm/ --extra-cflags='-DANDROID -fPIC -ffunction-sections -funwind-tables -fstack-protector -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fomit-frame-pointer -fstrict-aliasing -funswitch-loops -finline-limit=300 ' --extra-ldflags='-Wl,--fix-cortex-a8' --extra-ldexeflags=-pie --target-os=android --disable-static --enable-shared --disable-doc --disable-programs --disable-everything --disable-avdevice --disable-avformat --disable-swscale --disable-postproc --disable-avfilter --disable-symver --disable-swresample --enable-avresample --disable-decoder=vorbis --disable-decoder=opus --enable-decoder=flac --enable-decoder=ape --enable-asm --enable-yasm"
