...
#define FFMPEG_CONFIGURATION "--libdir=android-libs/armeabi-v7a --arch=arm --cpu=armv7-a --incdir=/mnt/d/android-project/ExoplayerSample/ExoPlayer/extensions/ffmpeg/src/main/jni/includes --cross-prefix=/mnt/d/ubuntu/android-ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi- --sysroot=/mnt/d/ubuntu/android-ndk/platforms/android-19/arch-arm/ --extra-cflags='-march=armv7-a -mfloat-abi=softfp' --extra-ldflags='-Wl,--fix-cortex-a8' --extra-ldexeflags=-pie --target-os=android --disable-static --enable-shared --disable-doc --disable-programs --disable-everything --disable-avdevice --enable-avformat --disable-swscale --disable-postproc --disable-avfilter --disable-symver --disable-swresample --enable-avresample --disable-decoder=vorbis --disable-decoder=opus --enable-decoder=ape --disable-decoder=flac"
